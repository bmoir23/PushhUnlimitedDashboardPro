    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div>
            <h3 className="text-sm font-medium text-slate-500 mb-1">Plan</h3>
            <p className="font-medium">{formatRole(user.plan || 'Free')}</p>
          </div>
          
          {user.username && (
            <div>
              <h3 className="text-sm font-medium text-slate-500 mb-1">Username</h3>
